...
function download_code()
{
    if [ -d ${AGENT_PATH}/presenteragent ];then
        ...
        presenteragent_download_url="https://github.com/Atlas200DKTest/sdk-presenter/archive/1.2.0.zip"
    ...
    rm -rf ${AGENT_PATH}/sdk-presenter-${presenteragent_version}-${presenteragent_version}
    return 0
